...
//    aNew = realloc(p->aiException, (p->nException+nEntry)*sizeof(int));
//      
...
//  pNew = (unicode_tokenizer *) malloc(sizeof(unicode_tokenizer));
...
//  pCsr = (unicode_cursor *)malloc(sizeof(unicode_cursor));
//    
//  if( pCsr==0 ){
//    return SQLITE_NOMEM;
//  }
